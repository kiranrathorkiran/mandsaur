...
function Header() {
  return (
    <header
      className="w-screen p-0 m-0  w-screen mx-auto px-4 bg-cover bg-center  h-96 Md:w-full md:h-screen flex justify-center items-center font-medium text-white text-center  text-xl  backdrop-blur sm:text-5xl md:text-6xl"
...
function Section({ title, imageSrc, altText, description }) {
  return (
    <div className=" bg-slate-900 w-screen  mx-auto px-4 p-0 m-0  h-full   md:flex-row  flex flex-col items-center text-center ">
...
function Map() {
  return (
    <div className="bg-slate-900 w-screen p-0  mx-auto px-4 m-0  h-full flex flex-col items-center text-center ">
